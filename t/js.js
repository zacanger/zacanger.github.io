...
assign(CallbackQueue.prototype, {
  ...
  notifyAll: function() {
    ...
    if (callbacks) {
      ("production" !== "prodution" ? invariant(
...
var Danger = {
  ...
  dangerouslyReplaceNodeWithMarkup: function(oldChild, markup) {
    ...
    ("production" !== "prodution" ? invariant(markup, 'dangerouslyReplaceNodeWithMarkup(...): Missing markup.') : invariant(markup));
    ("production" !== "prodution" ? invariant(
...
var LocalEventTrapMixin = {
  trapBubbledEvent:function(topLevelType, handlerBaseName) {
    ("production" !== "prodution" ? invariant(this.isMounted(), 'Must be mounted to trap events') : invariant(this.isMounted()));
...
function validateDangerousTag(tag) {
  if (!hasOwnProperty.call(validatedTagCache, tag)) {
    ("production" !== "prodution" ? invariant(VALID_TAG_REGEX.test(tag), 'Invalid tag: %s', tag) : invariant(VALID_TAG_REGEX.test(tag)));
  ...
  for (var propName in propTypes) {
    if (propTypes.hasOwnProperty(propName)) {
      ...
      if (error instanceof Error && !(error.message in loggedTypeFailures)) {
        ...
        var addendum = getDeclarationErrorAddendum(this);
        ("production" !== "prodution" ? warning(false, 'Failed propType: %s%s', error.message, addendum) : null);
      }
    }
  }
}
...
function createNodesFromMarkup(markup, handleScript) {
  var node = dummyNode;
  ("production" !== "prodution" ? invariant(!!dummyNode, 'createNodesFromMarkup dummy not initialized') : invariant(!!dummyNode));
...
function getMarkupWrap(nodeName) {
  ("production" !== "prodution" ? invariant(!!dummyNode, 'Markup wrapping node not initialized') : invariant(!!dummyNode));
...
, registerCommands () {
    this.setState({
      ...
      , 'lite'    : this.openLink('http://zacanger.com/l')
